...
<div class="container-fluid">
    <div class="row">
        <div class="col"><?php include 'barra_de_navegacao.php';?>
    ...
    <div class="col">
        <h2>Cadastro de Empréstimo</h2><br>
            <form method="POST" action="script_controlador.php?acao=cadastra_emprestimo">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="id_coisa" class="form-control">
                            ...
                            <option value="<?php echo $coisa->id_coisa?>"><?php echo $coisa->nome_coisa?></option>
                            <?php }; ?>
                        </select>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-6"> 
                        <label for="destinatario">Nome do destinatário (não é necessário cadastro prévio)</label><br>
